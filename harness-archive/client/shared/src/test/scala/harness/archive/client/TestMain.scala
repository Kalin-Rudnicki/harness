...
object TestMain extends ExecutableApp {
  ...
  override val executable: Executable =
    Executable
      ...
      .withEffect {
        for {
          _ <- ZIO.unit.trace("INFO", Logger.LogLevel.Info, "round" -> 1, "type" -> "trace")
          _ <- ZIO.unit.trace("DEBUG", Logger.LogLevel.Debug, "round" -> 1, "type" -> "trace")
          _ <- ZIO.unit.trace("TRACE", Logger.LogLevel.Trace, "round" -> 1, "type" -> "trace")
          ...
          _ <- ZIO.unit.trace("INFO", Logger.LogLevel.Info, "round" -> 2, "type" -> "trace")
          _ <- ZIO.unit.trace("DEBUG", Logger.LogLevel.Debug, "round" -> 2, "type" -> "trace")
          _ <- ZIO.unit.trace("TRACE", Logger.LogLevel.Trace, "round" -> 2, "type" -> "trace")
