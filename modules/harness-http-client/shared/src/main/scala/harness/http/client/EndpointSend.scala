...
final class EndpointSend[ET <: EndpointType.Any](url: String, spec: EndpointSpec[ET]) {
  ...
  private def sendWith(
    ...
    HttpClient.httpClientRef.getWith(_.send[ET](spec.inputBodyCodec, spec.outputBodyCodec, spec.errorCodec)(reqParams, b))
  }

  /**
    * Scoped versions of functions are needed if you want to interact with a raw output stream
    */
  def sendWithAuthScoped(p: Path[ET], q: Query[ET], a: Auth[ET], h: Header[ET], b: Send[InputBody[ET]]): ZIO[Scope, Error[ET], Receive[OutputBody[ET]]] =
    sendWith(p, q, a.some, h, b)

  /**
    * Scoped versions of functions are needed if you want to interact with a raw output stream
    */
  def sendWithoutAuthScoped(p: Path[ET], q: Query[ET], h: Header[ET], b: Send[InputBody[ET]]): ZIO[Scope, Error[ET], Receive[OutputBody[ET]]] =
    sendWith(p, q, None, h, b)

  /**
    * Scoped versions of functions are needed if you want to interact with a raw output stream
    */
  def sendWithAuth(p: Path[ET], q: Query[ET], a: Auth[ET], h: Header[ET], b: Send[InputBody[ET]]): IO[Error[ET], Receive[OutputBody[ET]]] =
    ZIO.scoped { sendWith(p, q, a.some, h, b) }

  /**
    * Scoped versions of functions are needed if you want to interact with a raw output stream
    */
  def sendWithoutAuth(p: Path[ET], q: Query[ET], h: Header[ET], b: Send[InputBody[ET]]): IO[Error[ET], Receive[OutputBody[ET]]] =
...
implicit class EndpointSendWithAuthOps[ET <: EndpointType.Any, O](es: EndpointSend[ET])(implicit zip: Zip5.Out[Path[ET], Query[ET], Auth[ET], Header[ET], Send[InputBody[ET]], O]) {
  ...
  def apply(o: O): IO[Error[ET], Receive[OutputBody[ET]]] = {
  ...
  def apply()(using ev: Unit <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
    apply(ev(()))

  def apply[A1, A2](a1: A1, a2: A2)(using ev: (A1, A2) <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
    apply(ev((a1, a2)))

  def apply[A1, A2, A3](a1: A1, a2: A2, a3: A3)(using ev: (A1, A2, A3) <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
    apply(ev((a1, a2, a3)))

  def apply[A1, A2, A3, A4](a1: A1, a2: A2, a3: A3, a4: A4)(using ev: (A1, A2, A3, A4) <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
    apply(ev((a1, a2, a3, a4)))

  def apply[A1, A2, A3, A4, A5](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5)(using ev: (A1, A2, A3, A4, A5) <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
    apply(ev((a1, a2, a3, a4, a5)))

  def apply[A1, A2, A3, A4, A5, A6](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6)(using ev: (A1, A2, A3, A4, A5, A6) <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
    apply(ev((a1, a2, a3, a4, a5, a6)))

  def apply[A1, A2, A3, A4, A5, A6, A7](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7)(using ev: (A1, A2, A3, A4, A5, A6, A7) <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
    apply(ev((a1, a2, a3, a4, a5, a6, a7)))

  def apply[A1, A2, A3, A4, A5, A6, A7, A8](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7, a8: A8)(using ev: (A1, A2, A3, A4, A5, A6, A7, A8) <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
    apply(ev((a1, a2, a3, a4, a5, a6, a7, a8)))

  def apply[A1, A2, A3, A4, A5, A6, A7, A8, A9](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7, a8: A8, a9: A9)(using ev: (A1, A2, A3, A4, A5, A6, A7, A8, A9) <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
    apply(ev((a1, a2, a3, a4, a5, a6, a7, a8, a9)))

  def apply[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10](a1: A1, a2: A2, a3: A3, a4: A4, a5: A5, a6: A6, a7: A7, a8: A8, a9: A9, a10: A10)(using ev: (A1, A2, A3, A4, A5, A6, A7, A8, A9, A10) <:< O): IO[ Error[ET], Receive[OutputBody[ET]]] =
