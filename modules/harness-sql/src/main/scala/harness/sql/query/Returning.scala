...
object Returning {
  ...
  given convertTable: [T[_[_]] <: Table] => (ti: TableSchema[T]) => Conversion[T[AppliedCol], Returning[T[K11.Identity]]] =
    t =>
      Returning(
  ...
  given convertOptTable: [T[_[_]] <: Table] => (ti: TableSchema[T]) => Conversion[T[AppliedCol.Opt], Returning[Option[T[K11.Identity]]]] =
    t =>
      Returning(
